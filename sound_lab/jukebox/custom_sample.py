...
def save_samples(model, device, hps, sample_hps, metatags):
    print(hps)
...
# changes v0.1
#    > add metatags param to save_samples()
#    > add metatags in run function
