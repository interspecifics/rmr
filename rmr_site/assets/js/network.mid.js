...
import { OrbitControls } from './assets/controls/OrbitControls.js';
  ...
  function animate() {
    ...
    var v2 = new THREE.Vector3(positions[3], positions[4], positions[5]);
    var v3 = new THREE.Vector3(positions[6], positions[7], positions[8]);
    ...
    const x = (pos.x *  .5 + .5) * canvas.clientWidth/1000;
    const y = (pos.y * -.5 + .5) * canvas.clientHeight/1000;
